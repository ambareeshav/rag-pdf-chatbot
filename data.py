"""
In this file, we read the pdf, convert it to text, chunk it and embedd it in a FAISS vector database
The db is stored as faiss_index locally to be loaded in the main file
"""
...
#initializing function for counting tokens in txt file
